...
mod sysex_types {
    ...
    pub enum TimeCodeCueingSetupMsg<'a> {
        TimeCodeOffset {
        ...
        EventStart {
            time_code: HighResTimeCode,
            event_number: u16,
            additional_information: Vec<MidiMsg<'a>>,
        },
        EventStop {
            time_code: HighResTimeCode,
            event_number: u16,
    ...
    impl<'a> TimeCodeCueingSetupMsg<'a> {
        pub(crate) fn extend_midi(&self, v: &mut Vec<u8>) {
            match self {
